...
fn main() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::update_repo_from_remote,
            ...
            commands::detect_hardware_profile,
                    ...
                    commands::read_modelfile_params,
                    commands::read_modelfile_data,
                    commands::save_modelfile_params,
                    ...
                    commands::launch_desktop_item,
                    commands::focus_window_by_title,
                    commands::check_gpu_available,
